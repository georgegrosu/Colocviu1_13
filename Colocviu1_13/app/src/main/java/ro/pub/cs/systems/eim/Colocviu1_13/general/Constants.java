package ro.pub.cs.systems.eim.Colocviu1_13.general;

public interface Constants {
    final public static String CLICKS_NO = "clicks_no";
    final public static String HISTORY = "history";

    final public static int SECONDARY_ACTIVITY_REQUEST_CODE = 2020;
    final public static String BROADCAST_RECEIVER_EXTRA = "bct_recv_extra";
